...
brx_vertex_shader_parameter_out(brx_float, out_vertex_linear_depth, 1) brx_vertex_shader_parameter_split
brx_vertex_shader_parameter_out(brx_float3, out_vertex_normal, 2) brx_vertex_shader_parameter_split
brx_vertex_shader_parameter_out(brx_float4, out_vertex_tagent, 3) brx_vertex_shader_parameter_split
brx_vertex_shader_parameter_out(brx_float2, out_vertex_texcoord, 4) 
brx_vertex_shader_parameter_end(main)
{
    ...
    out_vertex_linear_depth = vertex_position_clip_space.w;
