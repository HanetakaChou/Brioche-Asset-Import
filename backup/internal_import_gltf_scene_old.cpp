...
extern bool import_gltf_scene_asset_old(mcrt_vector<scene_mesh_data> &out_total_mesh_data, float frame_rate, brx_asset_import_input_stream_factory *input_stream_factory, char const *path)
{
    ...
    brx_motion_destroy_skeleton_animation(test_skeleton_animation);
    ...
    brx_motion_destroy_skeleton(test_skeleton);

    brx_motion_destroy_skeleton_animation_instance(test_skeleton_animation_instance);
#endif
