...
public:
    ...
    public:
        bool _is_null_lower_limitation_angle()
        {
            lower_limitation_angle();
            return n_lower_limitation_angle;
        };
    ...
    public:
        bool _is_null_upper_limitation_angle()
        {
            upper_limitation_angle();
            return n_upper_limitation_angle;
        };
    ...
    public:
        bool _is_null_skin_weights()
        {
            skin_weights();
            return n_skin_weights;
        };
    ...
    class text_t : public kaitai::kstruct
    {

    public:
        text_t(kaitai::kstream *p__io, kaitai::kstruct *p__parent = nullptr, mmd_pmx_t *p__root = nullptr);
    ...
    private:
        std::unique_ptr<text_t> m_name;
        std::unique_ptr<text_t> m_english_name;
        joint_type_t m_type;
    ...
    public:
        text_t *name() const { return m_name.get(); }
        text_t *english_name() const { return m_english_name.get(); }
    ...
    public:
        bool _is_null_connect_index()
        {
            connect_index();
            return n_connect_index;
        };
    ...
    public:
        bool _is_null_offset_position()
        {
            offset_position();
            return n_offset_position;
        };
    ...
    public:
        bool _is_null_local_x_vector()
        {
            local_x_vector();
            return n_local_x_vector;
        };
    ...
    public:
        bool _is_null_local_z_vector()
        {
            local_z_vector();
            return n_local_z_vector;
        };
    ...
    class text_utf16_t : public kaitai::kstruct
    {

    public:
        text_utf16_t(kaitai::kstream *p__io, mmd_pmx_t::text_t *p__parent = nullptr, mmd_pmx_t *p__root = nullptr);
    ...
    private:
        ...
        std::string m_value;
        mmd_pmx_t *m__root;
        mmd_pmx_t::text_t *m__parent;

    public:
        uint32_t length() const { return m_length; }
        std::string value() const { return m_value; }
        mmd_pmx_t *_root() const { return m__root; }
        mmd_pmx_t::text_t *_parent() const { return m__parent; }
    };
    ...
    public:
        ...
        uint32_t num_links() const { return m_num_links; }
        std::vector<std::unique_ptr<bone_ik_link_t>> *links() const { return m_links.get(); }
        mmd_pmx_t *_root() const { return m__root; }
        mmd_pmx_t::bone_t *_parent() const { return m__parent; }
    };

    class text_utf8_t : public kaitai::kstruct
    {

    public:
        text_utf8_t(kaitai::kstream *p__io, mmd_pmx_t::text_t *p__parent = nullptr, mmd_pmx_t *p__root = nullptr);
    ...
    private:
        ...
        std::unique_ptr<text_t> m_model_name;
        std::unique_ptr<text_t> m_english_model_name;
        std::unique_ptr<text_t> m_comment;
        std::unique_ptr<text_t> m_english_comment;
        mmd_pmx_t *m__root;
        mmd_pmx_t *m__parent;
    ...
    public:
        ...
        text_t *model_name() const { return m_model_name.get(); }
        text_t *english_model_name() const { return m_english_model_name.get(); }
        text_t *comment() const { return m_comment.get(); }
        text_t *english_comment() const { return m_english_comment.get(); }
        mmd_pmx_t *_root() const { return m__root; }
        mmd_pmx_t *_parent() const { return m__parent; }
    };
    ...
    public:
        ...
        text_t *comment() const { return m_comment.get(); }
        uint32_t face_num_vertices() const { return m_face_num_vertices; }
        mmd_pmx_t *_root() const { return m__root; }
        mmd_pmx_t *_parent() const { return m__parent; }
    };
...
public:
    ...
    uint32_t num_materials() const { return m_num_materials; }
    std::vector<std::unique_ptr<material_t>> *materials() const { return m_materials.get(); }
    uint32_t num_bones() const { return m_num_bones; }
    ...
    uint32_t num_rigid_bodies() const { return m_num_rigid_bodies; }
    std::vector<std::unique_ptr<rigid_body_t>> *rigid_bodies() const { return m_rigid_bodies.get(); }
    uint32_t num_joints() const { return m_num_joints; }
