...
private:
    ...
    uint8_t const *get_emissive_image_url() const override;
    brx_asset_import_vec3 get_emissive_factor() const override;
    uint8_t const *get_normal_image_url() const override;
    float get_normal_scale() const override;
    uint8_t const *get_base_color_image_url() const override;
    brx_asset_import_vec4 get_base_color_factor() const override;
    uint8_t const *get_metallic_roughness_image_url() const override;
