...
uint8_t const *brx_asset_import_mesh_surface::get_emissive_image_url() const
{
...
uint8_t const *brx_asset_import_mesh_surface::get_normal_image_url() const
{
...
uint8_t const *brx_asset_import_mesh_surface::get_base_color_image_url() const
{
...
uint8_t const *brx_asset_import_mesh_surface::get_metallic_roughness_image_url() const
{
