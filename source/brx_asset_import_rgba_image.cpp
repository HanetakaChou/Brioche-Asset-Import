...
brx_asset_import_rgba_image::brx_asset_import_rgba_image(mcrt_vector<uint32_t> &&pixel_data, uint32_t width, uint32_t height) : m_pixel_data(std::move(pixel_data)), m_width(width), m_height(height)
{
}
