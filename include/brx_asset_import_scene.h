...
{
    // にこり
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_BROW_HAPPY,
    // 怒り
    // 真面目
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_BROW_ANGRY,
    // 困る
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_BROW_SAD,
    // 上
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_BROW_SURPRISED,
    // まばたき
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_EYE_BLINK,
    // ウィンク２
    // ウィンク
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_EYE_BLINK_L,
    // ｳｨﾝｸ２右
    // ウィンク右
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_EYE_BLINK_R,
    // 笑い
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_EYE_HAPPY,
    // じと目
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_EYE_ANGRY,
    // 瞳縦潰れ
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_EYE_SAD,
    // びっくり
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_EYE_SURPRISED,
    // あ
    // あ２
    ...
    // にやり
    // にやり２
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_MOUTH_HAPPY,
    // ∧
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_MOUTH_ANGRY,
    // 口角下げ
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_MOUTH_SAD,
    // ▲
    BRX_ASSET_IMPORT_MORPH_TARGET_NAME_MMD_MOUTH_SURPRISED,
    //
